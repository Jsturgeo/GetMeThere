...
def potential_routes(current_location, closest_stations_start, closest_stations_end, destination_coords, method='bicycling'):
	first_legs = [{'start_coord' : current_location, 'end_coord' : station[2], 'mode' : 'walking'} for station in closest_stations_start]
	last_legs = [{'start_coord' : station[2], 'end_coord' : destination_coords, 'mode' : 'walking'} for station in closest_stations_end]
